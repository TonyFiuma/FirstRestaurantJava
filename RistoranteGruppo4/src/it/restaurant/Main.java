...
import it.restaurant.Money.Bill;
...
public class Main{
    ...
    public static void main(String[] args){
       ...
       menu.addListToMenu(wineList);
        ...
        Customer customer4 = new Customer("Andrea",MenuTypeEnum.CHILD);
        Customer customer5 = new Customer("Andrea",MenuTypeEnum.CHILD);
        ...
        menu.printMenuTypeByCustomerType(customer1);
        ...
        table1.reserveTable(4);

        restaurant.printRestaurantInfo();

        Bill bill1 = new Bill(reservation1);
        bill1.addDishAToTheBill(grigliataMista);
        bill1.addDishAToTheBill(grigliataMista);
        bill1.addDishAToTheBill(grigliataMista);
        bill1.printTheBill();
        Bill bill2 = new Bill(reservation1);
        bill2.addDishAToTheBill(stincoDiMaiale);
        bill2.addDishAToTheBill(chips);
        bill2.printTheBill();
